...
void		ps_printlists(t_icplist *a_list, t_icplist *b_list, \
			void (*pnt)(int));
...
void		go_to_intersection(t_ps_stack *stack, int min, \
			int max, int options);
void		go_to_endofbucket(t_ps_stack *stack, int min, \
			int max, int options);
void		go_to_bucket_ends(t_ps_stack *stack, int min, \
			int max, int options);
void		go_to_bucket_begins(t_ps_stack *stack, int min, \
			int max, int options);
...
void		insertion_minmax(t_ps_stack *from, t_ps_stack *to, \
			int min, int max);

/*ps_insertion_minmax_utils.c*/
int			closest_two_target(t_ps_stack *stack, int min, \
			int max, int *is_max);
...
int			execute_combo(t_ps_stack *stack, t_ps_stack *other, \
			int command, int options);
char		*inst_reverse(t_ps_stack *stack, t_ps_stack *other, \
			int command);
...
/*ps_trials_utils.c*/
void		trial_judge(t_ps_stack *challenger, t_idmlist **record, \
int first_try);
...
int			num_inst_equiv(t_ps_stack *send, t_ps_stack *receive, \
			int command);
int			num_combo_equiv(t_ps_stack *send, t_ps_stack *receive, \
			int command);
int			num_inst_reverse(t_ps_stack *send, t_ps_stack *receive, \
			int command);
